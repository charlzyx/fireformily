...
export const Popconfirm = (
  props: React.ComponentProps<typeof AntdPopconfirm> & IButtonType & { actions: Actions },
) => {
  const { body, field, header, loading, scope, open, reset, submit, visible } = usePopAction();
